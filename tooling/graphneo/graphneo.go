...
func Write(str string) {
	//log.Println(str)
	stmt, err := db.Prepare(fmt.Sprintf("CREATE %v\n", str))
	if err != nil {
		log.Fatal(err)
	}
	log.Println(stmt)
