...
func Start() {
	...
	priamCassandracount := 6 * archaius.Conf.Population / 100
	cname := "cassTurtle"
	...
	asgard.Run(asgard.Create(dns, asgard.DenominatorPkg, 0, 0, elbname), jname) // chaos monkey victim one of the javaweb
}
